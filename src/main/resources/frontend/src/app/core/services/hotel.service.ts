...
export class HotelService {
   ...
   * @param {Hotel} hotel - Datos del hotel a crear
   * @returns {Observable<HotelResponse>} Observable con el hotel creado
   */
  createHotel(hotel: Hotel): Observable<HotelResponse> {
   ...
   * @param {Hotel} hotel - Nuevos datos del hotel
   * @returns {Observable<HotelResponse>} Observable con el hotel actualizado
   */
  updateHotel(id: number, hotel: Hotel): Observable<HotelResponse> {
